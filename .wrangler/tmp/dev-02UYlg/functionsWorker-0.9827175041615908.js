...
// .wrangler/tmp/pages-W9UbIw/functionsWorker-0.9827175041615908.mjs
var __defProp2 = Object.defineProperty;
var __name2 = /* @__PURE__ */ __name((target, value) => __defProp2(target, "name", { value, configurable: true }), "__name");
var BOOSTY_URL = "https://boosty.to/quartzlab";
var EVENT_TYPE = "support_click";
var PLACE_PATTERN = /^[a-z0-9-]{1,40}$/i;
var LANGUAGE_PATTERN = /^(en|ru)$/;
var PATHNAME_PATTERN = /^\/[a-z0-9/_-]{0,160}$/i;
...
__name2(sanitizePlace, "sanitizePlace");
function sanitizeLanguage(value) {
  return LANGUAGE_PATTERN.test(String(value || "")) ? String(value).toLowerCase() : "en";
}
__name(sanitizeLanguage, "sanitizeLanguage");
__name2(sanitizeLanguage, "sanitizeLanguage");
...
__name(sanitizePathname, "sanitizePathname");
__name2(sanitizePathname, "sanitizePathname");
function resolveSupportEvent(request) {
...
__name(resolveSupportEvent, "resolveSupportEvent");
__name2(resolveSupportEvent, "resolveSupportEvent");
...
__name(validateAnalyticsPayload, "validateAnalyticsPayload");
__name2(validateAnalyticsPayload, "validateAnalyticsPayload");
...
__name(buildAnalyticsPayload, "buildAnalyticsPayload");
__name2(buildAnalyticsPayload, "buildAnalyticsPayload");
...
__name2(writeAnalytics, "writeAnalytics");
...
// .wrangler/tmp/bundle-TzPrYg/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-TzPrYg/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.9827175041615908.js.map
